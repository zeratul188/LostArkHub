...
public class Earring1DBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table EARRING1 (_id integer primary key, " +
    ...
    private static final String DATABASE_NAME = "LOSTARKHUB_EARRING1";
    private static final String DATABASE_TABLE = "EARRING1";
    ...
    public Earring1DBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS EARRING1");
            onCreate(db);
        }
    }

    public Earring1DBAdapter open() throws SQLException {
