...
public class Ring1DBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table RING1 (_id integer primary key, " +
    ...
    private static final String DATABASE_NAME = "LOSTARKHUB_RING1";
    private static final String DATABASE_TABLE = "RING1";
    ...
    public Ring1DBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS RING1");
            onCreate(db);
        }
    }

    public Ring1DBAdapter open() throws SQLException {
