...
public class Ring2DBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table RING2 (_id integer primary key, " +
    ...
    private static final String DATABASE_NAME = "LOSTARKHUB_RING2";
    private static final String DATABASE_TABLE = "RING2";
    ...
    public Ring2DBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS RING2");
            onCreate(db);
        }
    }

    public Ring2DBAdapter open() throws SQLException {
