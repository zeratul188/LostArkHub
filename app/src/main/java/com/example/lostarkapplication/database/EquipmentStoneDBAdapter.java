...
public class EquipmentStoneDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table EQUIPMENTSTONE (_id integer primary key, " +
    ...
    private static final String DATABASE_NAME = "LOSTARKHUB_EQUIPMENTSTONE";
    private static final String DATABASE_TABLE = "EQUIPMENTSTONE";
    ...
    public EquipmentStoneDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS EQUIPMENTSTONE");
            onCreate(db);
        }
    }

    public EquipmentStoneDBAdapter open() throws SQLException {
